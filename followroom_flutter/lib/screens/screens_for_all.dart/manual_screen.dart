                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(fontSize: 18, color: Colors.black), textAlign: TextAlign.justify,
                          ),
                          SizedBox(height: 15),
                          Text(
                          ...
                          SizedBox(height: 15),
                          Text(
                            '8.El establecimiento garantiza contar con alumbrado suficiente y sistemas de emergencia para mantener la visibilidad y seguridad',
                            style: TextStyle(fontSize: 18, color: Colors.black), textAlign: TextAlign.justify,
                          ),
                          SizedBox(height: 15),
                          Text(
